...
:Windows78
if not exist "%HomeDrive%\GHOS\MenuRemove.bat" (
goto NotMenu
)
...
:32Bit
set dd=%~dp0
RunAdmin32 "%dd%GHO_Win_78_Boot_Menu_UnInstall_Run.bat"
exit

:64Bit
set dd=%~dp0
RunAdmin64 "%dd%GHO_Win_78_Boot_Menu_UnInstall_Run.bat"
exit

:WinXP
GHO_Win_XP_Boot_Menu_UnInstall.bat
exit
