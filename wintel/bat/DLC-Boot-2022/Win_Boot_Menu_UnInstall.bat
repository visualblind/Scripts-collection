...
:Windows78
if not exist "%HomeDrive%\DLC1\MenuRemove.bat" (
goto NotMenu
)
...
:32Bit
set dd=%~dp0
RunAdmin32 "%dd%Win_78_Boot_Menu_UnInstall_Run.bat"
exit

:64Bit
set dd=%~dp0
RunAdmin64 "%dd%Win_78_Boot_Menu_UnInstall_Run.bat"
exit

:WinXP
Win_XP_Boot_Menu_UnInstall.bat
exit
