...
# UniFi Controller 5.10.17 auto installation script.
# OS       | Xenial
# Version  | 3.7.6
...
echo -e "${GREEN}#         ${RESET}Installing UniFi Controller 5.10.17!          ${GREEN}#${RESET}"
echo -e "${GREEN}#                                                      #${RESET}"
echo -e "${GREEN}########################################################${RESET}"
echo ""
sleep 2
...
then
  ...
  echo ""
  echo ""
  echo -e "${GREEN}#${RESET} UniFi SDN Controller 5.10.17 has been installed successfully"
  ...
  echo ""
  echo ""
  echo " Failed to successfully install UniFi SDN Controller 5.10.17"
  echo ""
