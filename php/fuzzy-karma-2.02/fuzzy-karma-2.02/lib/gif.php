	...
	class gif
	{
		...
		*/
		...
		/*
			...
			to the database.
		*/
		function gif($db) //Replace the function name with the name of the class
		{
			/*
		...
		*/
		...
		{
			$select = "SELECT active FROM fuzzy_preferences WHERE protocol=\"gifs\"";
		...
		*/
				function getData($db)
		{
			...
			*/
                        ...
                        */
                        $table_name = "fuzzy_GIFS";
                        $heading = "Fuzzy Packet Analysis - GIF Images";
                        $sub_heading = '';
                        $this_filename = "gif.php";
                        ...
                        while ($row =@ mysql_fetch_array($result))
                        {
                                ...
                                */
                                $protocol_html .= '
										...
										<tr bgcolor="'.$row_color.'">		
												<td colspan = "5">
                                                        <span style="color: '.$text_color.';"><img src="'.URL_VAR.'gifs/'.$row[id].'.gif"></span>
                                                </td>
                                        </tr>';
                        }
                        $protocol_html .= '</table>';
