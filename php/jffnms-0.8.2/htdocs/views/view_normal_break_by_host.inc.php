 ...
 */
	...
	ImageStringCenter ($im, $text_color, 0, array($host_name,$zone_shortname),$big_graph);
	$filename = "h$host-$big_graph.png";
	$url = "javascript:ir_url('events.php?express_filter=host,$host,=','')";
    }
?>
